...
func TestDirectionBetween_HexNeighboursLandOnSixtyDegreeSteps(t *testing.T) {
	...
	for _, c := range []struct {
		...
		{2, 1, DirE}, {0, 1, DirW},
		{2, 0, 60 / DirectionStep}, {1, 0, 120 / DirectionStep},
		{0, 2, 240 / DirectionStep}, {1, 2, 300 / DirectionStep},
	} {
	...
	if opposite(60/DirectionStep) != 240/DirectionStep {
		t.Errorf("opposite of 60° is %v°, want 240°", opposite(60/DirectionStep).Angle())
	}
}
