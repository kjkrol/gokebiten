...
var _ kinematics.Motion = (*RandomVelocity)(nil)
...
func (m *RandomVelocity) InitialVelocity(index, count int) kinematics.Velocity {
	...
	return kinematics.Velocity{Vec: geom.NewVec(dx, dy)}
}
